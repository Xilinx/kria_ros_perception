...
"""Tracepoint names."""
image_proc_rectify_cb_init = 'ros2_image_pipeline:image_proc_rectify_cb_init'
image_proc_rectify_init = 'ros2_image_pipeline:image_proc_rectify_init'
image_proc_rectify_fini = 'ros2_image_pipeline:image_proc_rectify_fini'
image_proc_rectify_cb_fini = 'ros2_image_pipeline:image_proc_rectify_cb_fini'
image_proc_resize_cb_init = 'ros2_image_pipeline:image_proc_resize_cb_init'
image_proc_resize_init = 'ros2_image_pipeline:image_proc_resize_init'
image_proc_resize_fini = 'ros2_image_pipeline:image_proc_resize_fini'
image_proc_resize_cb_fini = 'ros2_image_pipeline:image_proc_resize_cb_fini'
