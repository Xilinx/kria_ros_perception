...
DEFAULT_EVENTS_ROS = [
    tracepoints.image_proc_rectify_cb_init,
    tracepoints.image_proc_rectify_init,
    tracepoints.image_proc_rectify_fini,
    tracepoints.image_proc_rectify_cb_fini,
    tracepoints.image_proc_resize_cb_init,
    tracepoints.image_proc_resize_init,
    tracepoints.image_proc_resize_fini,
    tracepoints.image_proc_resize_cb_fini,
